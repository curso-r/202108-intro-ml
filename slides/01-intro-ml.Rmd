...
```{r, eval = TRUE}
df <- tribble(
  ~grau_do_polinomio, ~rmse_treino, ~rmse_teste,
  "1", 230.01, 310.3
)
...
problema: teremos que testar muitos 'lambdas'. Podemos desgastar a base de teste (erro de teste vai ter alta variabilidade). Para isso, inventaram a estratégia de reamostragem que oferece uma estimativa do erro de predição (erro de teste) com menor variabilidade.
